...
require_relative 'lib/fun_api/version'
...
Gem::Specification.new do |spec|
  ...
  spec.description = "Get an API started quickly, with performance in mind and, of course, have some fun with Ruby with performacne in mind? You've ended up in the right place!"
